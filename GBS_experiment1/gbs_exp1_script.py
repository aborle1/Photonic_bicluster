...
n_mean = 10 * 24 #24 is the number of modes, sf.apps.sample.sample divides n_mean by the total no of modes
shots = 1000
...
results_filepath = './results/' + 'res_gbs_exp1_photon'+str(n_mean)+'_shots'+str(shots)+'.npy'
