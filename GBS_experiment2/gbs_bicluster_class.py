...
class GBS_cluster:
    ...
    def make_data_binary(self,data_threshold=0.7):
        #Make the adjacency matrix into a binary matrix instead of a weighted graphs
        self.dataset_adj_matrix = np.where(self.dataset_adj_matrix >= data_threshold,1.0,0.0)