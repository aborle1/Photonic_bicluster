...
problem_filepath = './problems/gbs_exp2_part1.npz'
...
for i in range(7,10):
    ...
    results_filepath = './results/' + 'res_gbs_exp2_photon'+str(n_mean)+'_shots'+str(shots)+'_'+str(i)+'.npy'
    gbs_cluster.save_samples(results_filepath)

#Use python gbs_exp2_script.py
